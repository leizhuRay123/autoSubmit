...
var reason = flag.String("reason", "办公谁科研", "出入校事由")
...
func saveOut(sid string) string {
	...
	req, err := http.NewRequest("POST", "https://simso.pku.edu.cn/ssapi/stuaffair/epiAccess/saveSqxx?sid=" + sid + "&_sk=" + *username, body)
	if err != nil {
		panic(err)
	}
	req.Header.Set("Connection", "keep-alive")
...
func submitSqxx(sid string, row string) bool {
	...
	req, err := http.NewRequest("GET", "https://simso.pku.edu.cn/ssapi/stuaffair/epiAccess/submitSqxx?sid="+ sid + "&sqbh=" + row + "&_sk=" + *username, nil)
	if err != nil {
		panic(err)
	}
	req.Header.Set("Connection", "keep-alive")
...
func getSqzt(sid string) (string, string) {
	...
	req, err := http.NewRequest("GET", "https://simso.pku.edu.cn/ssapi/stuaffair/epiAccess/getSqzt?sid=" + sid + "&_sk=" + *username, nil)
	if err != nil {
		panic(err)
	}
	req.Header.Set("Connection", "keep-alive")
